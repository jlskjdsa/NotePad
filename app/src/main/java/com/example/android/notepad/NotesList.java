...
public class NotesList extends ListActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        // noteslist_item.xml
        int[] viewIDs = { android.R.id.text1 ,R.id.timestamp_view};
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        searchView.setOnQueryTextListener(new SearchView.OnQueryTextListener() {
            ...
            public boolean onQueryTextSubmit(String query) {
                searchNotes(query); // 当提交搜索时调用查询方法
                return true;
            }
    ...
    private void searchNotes(String query) {
        ...
        CustomCursorAdapter adapter = new CustomCursorAdapter(
                ...
                new int[]{android.R.id.text1, R.id.timestamp_view},
                false
        );
        setListAdapter(adapter);
    }
...
//END_INCLUDE(copy)
    ...
    private void refreshList(boolean isLight) {
        Cursor cursor = managedQuery(
                getIntent().getData(),
                PROJECTION,
                null,
        ...
        CustomCursorAdapter adapter = new CustomCursorAdapter(
                ...
                cursor,
                new String[]{NotePad.Notes.COLUMN_NAME_TITLE, NotePad.Notes.COLUMN_NAME_MODIFICATION_DATE},
                new int[]{R.id.text1, R.id.timestamp_view},
                isLight
        );
